        ...
        <div className="cta-actions" ref={actionsRef}>
          ...
          <div className="cta-contact-row">
            ...
            >
              ...
              <span>+233 256614336</span>
            </a>
            <div className="cta-divider"></div>
            <a href="mailto:barimahyawamponsah1844@gmail.com" className="cta-contact-item">
              barimahyawamponsah1844@gmail.com
            </a>
          </div>
        </div>
      </div>
